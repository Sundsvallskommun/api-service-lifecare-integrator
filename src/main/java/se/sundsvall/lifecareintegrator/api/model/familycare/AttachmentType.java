...
public class AttachmentType {
	...
	public List<Lookup> getSenderTypes() {
		return senderTypes;
	}

	public void setSenderTypes(final List<Lookup> senderTypes) {
		this.senderTypes = senderTypes;
	}

	public AttachmentType withSenderTypes(final List<Lookup> senderTypes) {
		this.senderTypes = senderTypes;
		return this;
	}
