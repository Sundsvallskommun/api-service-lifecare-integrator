...
public class ActualisationProposal {
	...
	private List<CodeItem> specifyTypes;

	@Schema(description = "The valid working statuses")
	private List<CodeItem> workingStatus;
	...
	public List<CodeItem> getSpecifyTypes() {
		return specifyTypes;
	}

	public void setSpecifyTypes(final List<CodeItem> specifyTypes) {
		this.specifyTypes = specifyTypes;
	}

	public ActualisationProposal withSpecifyTypes(final List<CodeItem> specifyTypes) {
		this.specifyTypes = specifyTypes;
		return this;
	}

	public List<CodeItem> getWorkingStatus() {
		return workingStatus;
	}

	public void setWorkingStatus(final List<CodeItem> workingStatus) {
		this.workingStatus = workingStatus;
	}

	public ActualisationProposal withWorkingStatus(final List<CodeItem> workingStatus) {
		this.workingStatus = workingStatus;
		return this;
	}
	...
	public void setOrganizations(final List<OrganizationItem> organizations) {
		this.organizations = organizations;
	}

	public ActualisationProposal withOrganizations(final List<OrganizationItem> organizations) {
		this.organizations = organizations;
		return this;
	}
