...
@RestController
@Validated
@RequestMapping("/{municipalityId}/payments")
@Tag(name = "Payments", description = "Payment reads from the Lifecare family care system")
@ApiResponses(value = {
...
class PaymentResource {
	...
	PaymentResource(final FamilyCareService familyCareService) {
	...
	ResponseEntity<PagedPaymentResponse> getPayments(
		@Parameter(name = "municipalityId", description = "Municipality id", example = "2281") @ValidMunicipalityId @PathVariable final String municipalityId,
		@Valid final PeriodParameters parameters) {

		return ok(familyCareService.getPayments(municipalityId, parameters));
	}
}
