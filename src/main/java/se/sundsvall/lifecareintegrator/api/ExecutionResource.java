...
@RestController
@Validated
@RequestMapping("/{municipalityId}/executions")
@Tag(name = "Executions", description = "Execution reads from the Lifecare family care system")
@ApiResponses(value = {
...
class ExecutionResource {
	...
	ExecutionResource(final FamilyCareService familyCareService) {
	...
	ResponseEntity<PagedExecutionResponse> getExecutions(
		@Parameter(name = "municipalityId", description = "Municipality id", example = "2281") @ValidMunicipalityId @PathVariable final String municipalityId,
		@Valid final PeriodParameters parameters) {

		return ok(familyCareService.getExecutions(municipalityId, parameters));
	}
}
