...
@RestController
@Validated
@RequestMapping("/{municipalityId}/resource-allocations")
@Tag(name = "Resource allocations", description = "Resource allocation reads from the Lifecare family care system")
@ApiResponses(value = {
...
class ResourceAllocationResource {
	...
	ResourceAllocationResource(final FamilyCareService familyCareService) {
	...
	ResponseEntity<PagedResourceAllocationResponse> getResourceAllocations(
		@Parameter(name = "municipalityId", description = "Municipality id", example = "2281") @ValidMunicipalityId @PathVariable final String municipalityId,
		@Valid final PeriodParameters parameters) {

		return ok(familyCareService.getResourceAllocations(municipalityId, parameters));
	}
}
