...
@Tag(name = "Services", description = "Service reads from the Lifecare family care system")
@ApiResponses(value = {
...
class ServiceResource {
	...
	ServiceResource(final FamilyCareService familyCareService) {
	...
	ResponseEntity<PagedServiceResponse> getServices(
		@Parameter(name = "municipalityId", description = "Municipality id", example = "2281") @ValidMunicipalityId @PathVariable final String municipalityId,
		@Valid final PeriodParameters parameters) {

		return ok(familyCareService.getServices(municipalityId, parameters));
	}
}
