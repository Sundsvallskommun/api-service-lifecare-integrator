 ...
 * auth is added globally by {@link LifecareEcConfiguration}, so it is not part of these method signatures. Citizen
 * lookup is done by the caller as {@code q=PersonId='YYYYMMDDXXXX'}.
 */
