 ...
 * query parameters, plus an {@code X-API-Key} header, by {@link LifecareEcConfiguration}. The key is sensitive — keep
 * it in a secret, never in
 * committed config, and out of request logging.
 */
@Validated
