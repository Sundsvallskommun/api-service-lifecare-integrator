...
class ActualisationTypeTest {
	...
	void testBuilderMethods() {
		...
		final var reasons = List.of(CodeItem.create());
		final var fromWho = List.of(CodeItem.create());
		final var investigationTypes = List.of(CodeItem.create());
		final var serviceTypes = List.of(CodeItem.create());
