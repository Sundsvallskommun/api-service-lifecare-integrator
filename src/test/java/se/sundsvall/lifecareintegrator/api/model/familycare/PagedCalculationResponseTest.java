...
class PagedCalculationResponseTest {
	...
	@Test
	void testBean() {
		MatcherAssert.assertThat(PagedCalculationResponse.class, allOf(
	...
	void testBuilderMethods() {
		// Arrange
		final var calculations = List.of(Calculation.create());
		...
		// Act
		final var result = PagedCalculationResponse.create()
	...
	void testNoDirtOnCreatedBean() {
		assertThat(PagedCalculationResponse.create()).hasAllNullFieldsOrProperties();
	}
}
