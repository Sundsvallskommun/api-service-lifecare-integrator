...
class CalculationProposalTest {
	...
	void testBuilderMethods() {
		...
		final var incomeTypes = List.of(CodeItem.create());
		final var expenseTypes = List.of(CodeItem.create());
		final var specialExpenseTypes = List.of(CodeItem.create());
		final var actualisationMandatory = true;
		final var numberOfFamilyMembersNotInHousehold = 0;
		final var actualisations = List.of(ActualisationItem.create());
