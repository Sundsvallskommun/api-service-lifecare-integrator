...
class PagedActualisationResponseTest {
	...
	@Test
	void testBean() {
		MatcherAssert.assertThat(PagedActualisationResponse.class, allOf(
	...
	void testBuilderMethods() {
		// Arrange
		final var actualisations = List.of(Actualisation.create());
		...
		// Act
		final var result = PagedActualisationResponse.create()
	...
	void testNoDirtOnCreatedBean() {
		assertThat(PagedActualisationResponse.create()).hasAllNullFieldsOrProperties();
	}
}
