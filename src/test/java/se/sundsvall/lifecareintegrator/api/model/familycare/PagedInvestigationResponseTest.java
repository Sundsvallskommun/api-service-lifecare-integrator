...
class PagedInvestigationResponseTest {
	...
	@Test
	void testBean() {
		MatcherAssert.assertThat(PagedInvestigationResponse.class, allOf(
	...
	void testBuilderMethods() {
		// Arrange
		final var investigations = List.of(Investigation.create());
		...
		// Act
		final var result = PagedInvestigationResponse.create()
	...
	void testNoDirtOnCreatedBean() {
		assertThat(PagedInvestigationResponse.create()).hasAllNullFieldsOrProperties();
	}
}
