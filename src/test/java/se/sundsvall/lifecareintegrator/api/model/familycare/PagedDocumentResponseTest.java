...
class PagedDocumentResponseTest {
	...
	@Test
	void testBean() {
		MatcherAssert.assertThat(PagedDocumentResponse.class, allOf(
	...
	void testBuilderMethods() {
		// Arrange
		final var documents = List.of(DocumentMetadata.create());
		...
		// Act
		final var result = PagedDocumentResponse.create()
