...
class OrganizationItemTest {
	...
	@Test
	void testBean() {
		MatcherAssert.assertThat(OrganizationItem.class, allOf(
	...
	void testBuilderMethods() {
		...
		// Act
		final var result = OrganizationItem.create()
			.withId(id)
			.withUnitId(unitId)
			.withName(name);
	...
	void testNoDirtOnCreatedBean() {
		assertThat(OrganizationItem.create()).hasAllNullFieldsOrProperties();
	}
}
